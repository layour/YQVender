...
var config = {
    ...
    bank_type:[
        ...
        {"type":"CSCB","name":"长沙银行"},
        {"type":"CDB","name":"承德银行"},
        {"type":"CDRCB","name":"成都农商银行"},
        {"type":"CRCB","name":"重庆农村商业银行"},
        {"type":"CQB","name":"重庆银行"},
        {"type":"DLB","name":"大连银行"},
        {"type":"DYCCB","name":"东营市"}
    ],
    vender_resource: [
        ...
        },
        {
            ...
            "subclass":[
                {"type":"C0","name":"0#柴油"},
                {"type":"C-10","name":"10#柴油"},
                {"type":"C-15","name":"15#柴油"},
                {"type":"C-20","name":"20#柴油"},
                {"type":"C-35","name":"35#柴油"},
                {"type":"C-50","name":"50#柴油"}
            ],
            "number":[
                {"type":"1","name":"1号枪"},
                {"type":"2","name":"2号枪"},
        ...
        },
        {
            ...
            "id": 3,
            "subclass":[
                {"type":"CNG","name":"CNG天然气"},
                {"type":"LNG","name":"LNG天然气"}
            ],
            "number":[
                {"type":"1","name":"1号枪"},
                {"type":"2","name":"2号枪"},
...
function ajaxRequest(params) {
    ...
    var reg1 = /register/;
    var reg2 = /login/;
    var reg3 = /forgetPassword/;

    if (!token) {
        if (!(reg1.test(pathname) || reg2.test(pathname) || reg3.test(pathname))) {
            pageGo("login");
        }
    }
...
function ProvinceCityDistrict(range) {
    ...
    var addressData='';
    $.getJSON('../../static/js/lib/pca-code.json',function (data) {
